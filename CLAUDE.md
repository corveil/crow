...
crow corveil link-gateway (--workspace NAME | --manager) --org ID [--org-name N] [--force]  → {"saved":true,"linked":true,"target":"...","target_name":"...","org":{org_id,org_name,key_prefix,created_at}}
```
