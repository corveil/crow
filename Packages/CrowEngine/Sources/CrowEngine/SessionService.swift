...
public final class SessionService {
    ...
    public init(store: JSONStore, appState: AppState, telemetryPort: UInt16? = nil, providerManager: ProviderManager? = nil, hostBridge: HostBridge = NoopHostBridge()) {
        self.store = store
    ...
    public func completeSession(id: UUID) {
