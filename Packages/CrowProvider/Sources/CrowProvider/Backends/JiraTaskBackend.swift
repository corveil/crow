...
/// with no code surface" shape ADR 0005 carved out. A Jira-tasked session pairs
/// with a GitHub/GitLab `CodeBackend` (resolved via `Session.codeProvider`);
/// `ProviderManager.codeBackend(.jira)` returns `nil`.
///
