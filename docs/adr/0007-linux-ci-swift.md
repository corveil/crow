...
- **Amended 2026-09-01 (CROW-1150):** Self-hosted was tried and dropped. `corveil/crow` is public, so GitHub-hosted `macos-15` / `ubuntu-latest` do not bill Actions minutes. There is no `CROW_SIGNING_RUNS_ON` switch.
