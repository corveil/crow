...
(`Ready` → `To Do`, all others use the state name verbatim) for any unmapped state. If
your prompt already includes a "Jira Status Mapping" section, that is the same map —
prefer it.
